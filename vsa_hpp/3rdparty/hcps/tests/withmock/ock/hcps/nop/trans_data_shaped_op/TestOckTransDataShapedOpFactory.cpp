...
namespace nop {
namespace test {
class TestOckTransDataShapedOpFactory : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckTransDataShapedOpFactory, create_op)
{
    ...
    auto distOp =
        OckTransDataShapedOpFactory::Create(opSpec)->Create(buffer);
