...
namespace nop {
namespace test {
class TestOckTransDataCustomAttrOpFactory : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckTransDataCustomAttrOpFactory, create_op)
{
    ...
    auto distOp =
        OckTransDataCustomAttrOpFactory::Create(opSpec)->Create(buffer);
