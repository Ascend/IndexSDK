...
namespace nop {
namespace test {
class TestOckTopkFlatOpFactory : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckTopkFlatOpFactory, create_op)
{
    ...
    auto topkOp = OckTopkFlatOpFactory::Create(opSpec)->Create(buffer);
    EXPECT_EQ(topkOp->ResourceType(), acladapter::OckTaskResourceType::DEVICE_AI_CPU);
}
} // namespace test
} // namespace nop
} // namespace hcps
