...
namespace nop {
namespace test {
class TestOckRemoveDataAttrOpRun : public handler::WithEnvOckHeteroHandler<testing::Test> {
public:
...
TEST_F(TestOckRemoveDataAttrOpRun, create_op)
{
    PrepareHostData(32U);
    ...
    auto op = OckRemoveDataAttrOpRun::CreateOp(hmoBlock, *handler);
    mockStream->AddOp(op);
