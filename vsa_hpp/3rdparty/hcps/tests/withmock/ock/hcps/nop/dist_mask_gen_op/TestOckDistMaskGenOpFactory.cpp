...
namespace nop {
namespace test {
class TestOckDistMaskGenOpFactory : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckDistMaskGenOpFactory, create_op)
{
    ...
    auto distOp =
        OckDistMaskGenOpFactory::Create(opSpec)->Create(buffer);
