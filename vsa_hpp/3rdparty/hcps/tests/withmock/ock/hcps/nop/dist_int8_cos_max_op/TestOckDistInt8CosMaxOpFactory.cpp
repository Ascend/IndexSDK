...
namespace nop {
namespace test {
class TestOckDistInt8CosMaxOpFactory : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckDistInt8CosMaxOpFactory, create_op)
{
    ...
    auto distOp =
        OckDistInt8CosMaxOpFactory::Create(opSpec)->Create(buffer);
