...
namespace nop {
namespace test {
class TestOckRemoveDataCustomAttrOpFactory : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckRemoveDataCustomAttrOpFactory, create_op)
{
    ...
    auto distOp =
        OckRemoveDataCustomAttrOpFactory::Create(opSpec)->Create(buffer);
    EXPECT_EQ(distOp->ResourceType(), acladapter::OckTaskResourceType::DEVICE_AI_CPU);
}
} // namespace test
} // namespace nop
} // namespace hcps
