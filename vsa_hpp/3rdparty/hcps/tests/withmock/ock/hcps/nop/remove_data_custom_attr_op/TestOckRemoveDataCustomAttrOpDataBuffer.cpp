...
namespace nop {
namespace test {
class TestOckRemoveDataCustomAttrOpDataBuffer : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckRemoveDataCustomAttrOpDataBuffer, alloc_buffers_from_hmo_block)
{
    BuildHmoBlock();
    auto buffer = ock::hcps::nop::OckRemoveDataCustomAttrOpDataBuffer::Create(opSpec, bufferSpec);
