...
namespace nop {
namespace test {
class TestOckRemoveDataAttrOpFactory : public acladapter::WithEnvAclMock<testing::Test> {
public:
...
TEST_F(TestOckRemoveDataAttrOpFactory, create_op)
{
    ...
    auto distOp =
        OckRemoveDataAttrOpFactory::Create(opSpec)->Create(buffer);
