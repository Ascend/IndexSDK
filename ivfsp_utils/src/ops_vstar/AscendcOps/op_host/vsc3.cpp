...
namespace optiling {
    static ge::graphStatus TilingFunc(gert::TilingContext* context)
    {
        ...
        if (shapeQueryCode == nullptr || nlist1 == 0) {
            return ge::GRAPH_FAILED;
        }
        ...
        // nprobe2 = 18 理想情况：前2个core每个core处理6个probe，后6个core每个core处理2个probe。
...
namespace ops {
    class VSC3 : public OpDef {
    public:
        explicit VSC3(const char* name) : OpDef(name)
        {
