...
protected:
    ...
    virtual void addCoarseCentroidsAiCpu(AscendTensor<float16_t, DIMS_2> &src, AscendTensor<float16_t, DIMS_4> &dst);

    virtual void addCoarseCentroidsCtrlCpu(AscendTensor<float16_t, DIMS_2> &src, AscendTensor<float16_t, DIMS_4> &dst);
};
}  // namespace ascendSearch
