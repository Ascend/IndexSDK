...
#include <ascenddaemon/utils/CircularQueue.h>
...
template<typename D, typename __Compare, typename IDX>
void popHeapFuzzy(size_t k, D *heapDist, IDX *heapId, __Compare compare)
{
