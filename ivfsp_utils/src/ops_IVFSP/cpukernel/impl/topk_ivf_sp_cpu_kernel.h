...
#ifndef AICPU_TOPK_IVF_SP_CPU_KERNEL_H
#define AICPU_TOPK_IVF_SP_CPU_KERNEL_H
...
namespace aicpu {
class TopkIvfSpCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    TopkIvfSpCpuKernel() = default;

    ~TopkIvfSpCpuKernel() override = default;
