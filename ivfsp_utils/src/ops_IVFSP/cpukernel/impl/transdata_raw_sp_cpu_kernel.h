...
#ifndef AICPU_TRANSDATA_RAW_SP_CPU_KERNEL_H
#define AICPU_TRANSDATA_RAW_SP_CPU_KERNEL_H
...
namespace aicpu {
class TransdataRawSpCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    TransdataRawSpCpuKernel() = default;

    ~TransdataRawSpCpuKernel() override = default;
