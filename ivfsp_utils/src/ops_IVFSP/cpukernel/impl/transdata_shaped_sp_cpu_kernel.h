...
#ifndef AICPU_TRANSDATA_SHAPED_SP_CPU_KERNEL_H
#define AICPU_TRANSDATA_SHAPED_SP_CPU_KERNEL_H
...
namespace aicpu {
class TransdataShapedSpCpuKernel : public CpuKernel {
struct Inputs {
...
struct Outputs {
    Tensor *outshaped = nullptr;
};

public:
    TransdataShapedSpCpuKernel() = default;

    ~TransdataShapedSpCpuKernel() override = default;
