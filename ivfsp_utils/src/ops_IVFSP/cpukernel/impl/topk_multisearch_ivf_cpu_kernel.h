...
#ifndef AICPU_TOPK_MULTISEARCH_IVF_CPU_KERNEL_H
#define AICPU_TOPK_MULTISEARCH_IVF_CPU_KERNEL_H
...
namespace aicpu {
class TopkMultisearchIvfCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    TopkMultisearchIvfCpuKernel() = default;

    ~TopkMultisearchIvfCpuKernel() override = default;
