...
#ifndef AICPU_VEC_L2SQR_SP_CPU_KERNEL_H
#define AICPU_VEC_L2SQR_SP_CPU_KERNEL_H
...
namespace aicpu {
class VecL2sqrSpCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    VecL2sqrSpCpuKernel() = default;

    ~VecL2sqrSpCpuKernel() override = default;
