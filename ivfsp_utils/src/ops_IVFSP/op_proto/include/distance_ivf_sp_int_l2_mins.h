...
#ifndef GE_OP_DISTANCE_IVF_SP_INT_L2_MINS_H
#define GE_OP_DISTANCE_IVF_SP_INT_L2_MINS_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceIVFSpIntL2Mins)
        ...
        .INPUT(x3, TensorType({ DT_FLOAT }))                /* "Third operand." */
        .INPUT(x4, TensorType({ DT_FLOAT16 }))              /* "Fourth operand." */
        ...
        .OP_END_FACTORY_REG(DistanceIVFSpIntL2Mins)
} // namespace ge
