...
#include "distance_masked_ivf_sp_int_l2_mins.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceMaskedIVFSpIntL2Mins, DistanceMaskedIVFSpIntL2MinsVerify)
    {
        DataType inputTypeX0 = op.GetInputDescByName("x0").GetDataType();
        DataType inputTypeX4 = op.GetInputDescByName("x5").GetDataType();
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceMaskedIVFSpIntL2MinsInferShape)
    {
        ...
        Shape x3_shape = op.GetInputDescByName("x4").GetShape();
        Shape x6_shape = op.GetInputDescByName("x6").GetShape();
        ...
        std::vector<int64_t> dims_x4 = x6_shape.GetDims();
        std::vector<int64_t> dim_y;
        dim_y.push_back(dims_x4[0]);
        dim_y.push_back(dims_x3[0]);
        ...
        dim_min_y.push_back(dims_x4[0]);
        dim_min_y.push_back((dims_x3[0] + 63) / 64 * 2);
        ...
        std::vector<int64_t> dimVec2 { 8, 16 };
    ...
    COMMON_INFER_FUNC_REG(DistanceMaskedIVFSpIntL2Mins, DistanceMaskedIVFSpIntL2MinsInferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceMaskedIVFSpIntL2Mins, DistanceMaskedIVFSpIntL2MinsVerify);
} // namespace ge