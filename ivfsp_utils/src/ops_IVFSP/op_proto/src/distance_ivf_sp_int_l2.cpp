...
#include "distance_ivf_sp_int_l2.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceIVFSpIntL2, DistanceIVFSpIntL2Verify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceIVFSpIntL2InferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceIVFSpIntL2, DistanceIVFSpIntL2InferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceIVFSpIntL2, DistanceIVFSpIntL2Verify);
} // namespace ge