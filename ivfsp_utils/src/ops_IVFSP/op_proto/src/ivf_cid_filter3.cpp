...
namespace ge {
    IMPLEMT_VERIFIER(IvfCidFilter3, IvfCidFilter3Verify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(IvfCidFilter3InferShape)
    {
        ...
        std::vector<int64_t> dim_y0 {dims_x3[1], dims_x0[0] / 16 }; // uint16_t have 16 bits
    ...
    COMMON_INFER_FUNC_REG(IvfCidFilter3, IvfCidFilter3InferShape);

    // Registered verify function
    VERIFY_FUNC_REG(IvfCidFilter3, IvfCidFilter3Verify);
} // namespace ge