...
#include "distance_ivf_sp_int_l2_mins.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceIVFSpIntL2Mins, DistanceIVFSpIntL2MinsVerify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceIVFSpIntL2MinsInferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceIVFSpIntL2Mins, DistanceIVFSpIntL2MinsInferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceIVFSpIntL2Mins, DistanceIVFSpIntL2MinsVerify);
} // namespace ge