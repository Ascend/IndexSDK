...
</li><li><span class="parmname" id="parmname146781148101815"><a name="parmname146781148101815"></a><a name="parmname146781148101815"></a>“filters”</span>需要为长度为n * 6的uint32_t的数组，否则可能出现越界读取的错误并引起程序崩溃。</li></ul>
</td>
</tr>
</tbody>
</table>
...
</li><li><span class="parmname" id="parmname198471438101916"><a name="parmname198471438101916"></a><a name="parmname198471438101916"></a>“filters”</span>需要为长度为n的指针数组，且数组中每个指针指向长度为indexes.size() * 6的uint32_t的数组，否则可能出现越界读取的错误并引起程序崩溃。</li></ul>
</td>
</tr>
</tbody>
</table>
