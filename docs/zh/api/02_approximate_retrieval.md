...
<td class="cellrowborder" valign="top" width="79.95%" headers="mcps1.1.3.6.1 "><a name="ul79274019592"></a><a name="ul79274019592"></a><ul id="ul79274019592"><li>dims目前仅支持128。</li><li>nlist ∈ {1024, 2048, 4096, 8192, 16384}。</li><li>msubs ∈ {2, 4, 8, 16}。</li><li>nbits目前支持8。</li><li>config.useKmeansPP代表是否启用npu聚类。设置useKmeansPP=false，表示使用CPU聚类。</li></ul>
</td>
</tr>
</tbody>
</table>
