...
AscendIndexCluster仅支持使用<term>Atlas 推理系列产品</term>，在标准态部署方式下的向量内积距离类型。AscendIndexCluster在使用时依赖Flat和AICPU算子，具体请参见[Flat](../user_guide.md#flat)和[AICPU](../user_guide.md#aicpu)。
...
AscendIndexILFlat仅支持使用<term>Atlas 推理系列产品</term>，在标准态部署方式下的向量内积距离类型。AscendIndexILFlat在使用时依赖Flat和AICPU算子，具体请参见[Flat](../user_guide.md#flat)和[AICPU](../user_guide.md#aicpu)。
