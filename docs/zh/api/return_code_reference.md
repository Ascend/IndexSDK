...
|APP_ERR_IVALID_HDC_DATA = 2002|invalid HDC transport data|
...
|APP_ERR_ILLEGAL_OPERATRION = 2009|illegal operation|
|APP_ERR_INNER_ERROR = 2010|internal error|
|APP_ERR_TIMEOUT = 2011|timeout|
|APP_CREATE_INDEX_FAILED = 2012|create index failed|
|APP_CREATE_TRANSFORM_FAILED = 2013|create index failed|
|APP_CREATE_INFERENCE_FAILED = 2014|create index failed|
