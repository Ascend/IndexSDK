...
<td class="cellrowborder" valign="top" width="85.42%" headers="mcps1.1.3.3.1 "><p id="p144431434393"><a name="p144431434393"></a><a name="p144431434393"></a>执行此命令，用户可以得到一组算子模型文件，用户需要自行修改命令中的参数。</p>
</td>
</tr>
