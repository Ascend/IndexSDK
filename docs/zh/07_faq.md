...
问题原因一：可参见《CANN 软件安装》中的“[执行ATC转换或模型训练时，报错：fatal error: 'cstdint' file not found](https://www.hiascend.com/document/detail/zh/canncommercial/900/softwareinst/instg/instg_0086.html)”章节中的“可能原因”部分。
