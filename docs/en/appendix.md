...
For the public network addresses included in the software, see [Index_SDK_Public_Network_Addresses.md](./resource/Index_SDK_Public_Network_Addresses.md).
...
- The 50 MB memory limit of the SSH service has been lifted to ensure that all dependent files can be sent. For details, see the "Using the DSMI Interface to Enable the SSH Service" section in the *CANN Software Installation Guide (Open State, Atlas Inference Series Product)*.
