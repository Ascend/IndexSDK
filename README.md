...
| 资源 | 说明 |
|:--|:--|
| [FAQ](./docs/zh/07_faq.md) | 常见问题解答与使用答疑 |
| [创建Issue](https://gitcode.com/Ascend/IndexSDK/issues/create/choose) | 提交 Bug、需求或建议 |
| [社区任务](https://gitcode.com/Ascend/IndexSDK/issues/14) | 查看和认领社区任务 |
