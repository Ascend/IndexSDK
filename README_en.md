...
The release notes for Index SDK include software version compatibility and the feature changes in each version. For details, see [Release Notes](./docs/en/release_notes_index.md).
