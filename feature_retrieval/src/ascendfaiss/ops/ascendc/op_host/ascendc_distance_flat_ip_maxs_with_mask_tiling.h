...
#ifndef ASCENDC_OP_HOST_DISTANCE_FLAT_IP_MAXS_WITH_MASK_TILING_H
#define ASCENDC_OP_HOST_DISTANCE_FLAT_IP_MAXS_WITH_MASK_TILING_H
...
#endif  // ASCENDC_OP_HOST_DISTANCE_FLAT_IP_MAXS_WITH_MASK_TILING_H
