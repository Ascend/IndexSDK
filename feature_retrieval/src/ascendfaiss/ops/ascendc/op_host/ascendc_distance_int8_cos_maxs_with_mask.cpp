...
#include "ascendc_distance_int8_cos_maxs_with_mask_tiling.h"
...
namespace optiling {
static ge::graphStatus TilingFillParam(AscendcDistanceInt8CosMaxsWithMaskTilingData &tiling,
...
static ge::graphStatus TilingFillCubeTiling(AscendcDistanceInt8CosMaxsWithMaskTilingData &tiling,
    gert::TilingContext *context)
{
...
static ge::graphStatus TilingFunc(gert::TilingContext *context)
{
    ...
    AscendcDistanceInt8CosMaxsWithMaskTilingData tiling;
...
namespace ops {
class AscendcDistanceInt8CosMaxsWithMask : public OpDef {
public:
    explicit AscendcDistanceInt8CosMaxsWithMask(const char* name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT8})
...
OP_ADD(AscendcDistanceInt8CosMaxsWithMask);
}
