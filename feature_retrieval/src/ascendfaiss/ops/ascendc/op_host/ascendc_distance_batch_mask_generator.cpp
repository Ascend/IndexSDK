...
#include "ascendc_distance_batch_mask_generator.h"
...
namespace ops
{
class AscendcDistanceBatchMaskGenerator : public OpDef
{
   public:
    explicit AscendcDistanceBatchMaskGenerator(const char* name) : OpDef(name)
    {
...
OP_ADD(AscendcDistanceBatchMaskGenerator);
}  // namespace ops
