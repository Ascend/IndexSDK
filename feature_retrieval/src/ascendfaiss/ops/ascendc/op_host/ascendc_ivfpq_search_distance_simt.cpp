...
namespace ops {
class AscendcIvfpqSearchDistanceSimt : public OpDef {
public:
    explicit AscendcIvfpqSearchDistanceSimt(const char *name) : OpDef(name)
    {
        this->Input("queryPQ")
            .ParamType(REQUIRED)
...
OP_ADD(AscendcIvfpqSearchDistanceSimt);
} // namespace ops
