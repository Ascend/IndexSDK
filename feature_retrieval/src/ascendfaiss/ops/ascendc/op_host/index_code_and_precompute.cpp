 ...
 *      l2_result: ||indexes - centroid||^2 = ||indexes||^2 - 2<indexes, centroid> + ||centroid||^2 -> n  (IP: ||indexes
 * - centroid||^2 - ||indexes||^2) l1_result: 2||indexes - centroid||^2 * sqrt(d) / ||indexes - centroid||1 -> n
 */
namespace ops
{
