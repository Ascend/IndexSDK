...
#ifndef INDEX_CODE_AND_PRECOMPUTE_TILING_H
#define INDEX_CODE_AND_PRECOMPUTE_TILING_H
...
namespace optiling {
BEGIN_TILING_DATA_DEF(IndexCodeAndPrecomputeTilingData)
    TILING_DATA_FIELD_DEF_STRUCT(TCubeTiling, gemm_qb_tiling);
    TILING_DATA_FIELD_DEF(int32_t, tileLength);       // vector 单元每次循环处理的向量数量
    TILING_DATA_FIELD_DEF(int32_t, tileLengthStage1); // vector 单元每次循环处理的向量数量
