...
#include "ascendc_ivfpq_search_distance_simd_tiling.h"
...
static ge::graphStatus TilingFunc(gert::TilingContext *context)
{
    ...
    AscendcIvfpqSearchDistanceSimdTopKTilingData tilingData;
...
namespace ops {
class AscendcIvfpqSearchDistanceSimdL2 : public OpDef {
public:
    explicit AscendcIvfpqSearchDistanceSimdL2(const char *name) : OpDef(name)
    {
        this->Input("queryPQ")
            .ParamType(REQUIRED)
...
OP_ADD(AscendcIvfpqSearchDistanceSimdL2);
} // namespace ops
