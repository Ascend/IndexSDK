...
#include "ascendc_ivfpq_search_distance_topk_simt.h"
#include "kernel_operator.h"

using namespace AscendC;

extern "C" __global__ __aicore__ void ascendc_ivfpq_search_distance_l2_simt(
    ...
    GM_ADDR topkValueFinal, GM_ADDR flag, GM_ADDR workspace, GM_ADDR tiling)
{
    TPipe tPipe;
    GET_TILING_DATA(tiling_data, tiling);
    IndexOps::AscendcIvfpqSearchDistanceTopKSimt op;
