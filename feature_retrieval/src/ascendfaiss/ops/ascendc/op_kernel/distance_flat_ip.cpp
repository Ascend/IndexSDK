...
public:
    __aicore__ inline DistanceFlatIP(const DistanceFlatIPTilingData &tilingData)
...
__aicore__ inline void DistanceFlatIP::SetFlag(uint32_t blockIdx)
{
...
__aicore__ inline void DistanceFlatIP::GetActualSize()
{
    TBuf<> actualSizeBuf;
...
__aicore__ inline void DistanceFlatIP::GetMaskParameters(GM_ADDR actualSize)
{
...
__aicore__ inline void DistanceFlatIP::ComputeLoopParameters()
{
    // 实际要计算的底库数量
    GetActualSize();
...
__aicore__ inline void DistanceFlatIP::Init(GM_ADDR query, GM_ADDR mask, GM_ADDR shaped, GM_ADDR actualSize,
                                            GM_ADDR dist, GM_ADDR maxDist, GM_ADDR flag,
                                            GM_ADDR workspace)
{
...
__aicore__ inline void DistanceFlatIP::Process()
{
...
__aicore__ inline void DistanceFlatIP::DistanceComputeLoop(uint32_t aicoreMoveOffset,
                                                           uint32_t aicoreCodeNum,
                                                           uint32_t queryMoveOffset,
                                                           uint32_t queryMoveNum,
                                                           bool isTail)
...
__aicore__ inline void DistanceFlatIP::CopyDist2GM(const LocalTensor<half> &distTensor,
                                                   uint32_t codeMoveOffset,
                                                   uint32_t codeMoveNum,
                                                   uint32_t queryMoveOffset,
                                                   uint32_t queryMoveNum)
...
__aicore__ inline void DistanceFlatIP::ComputeExtremum(const LocalTensor<half> &dist,
                                                       uint32_t codeMoveNum,
                                                       uint32_t queryMoveNum,
                                                       LocalTensor<half> &distExtremum)
{
...
__aicore__ inline void DistanceFlatIP::CopyDistExtremum2GM(const LocalTensor<half> &distExtremum,
                                                           uint32_t codeMoveOffset,
                                                           uint32_t codeMoveNum,
                                                           uint32_t queryMoveOffset,
                                                           uint32_t queryMoveNum)
...
__aicore__ inline void DistanceFlatIP::DoMask(uint32_t codeMoveOffset,
                                              uint32_t codeMoveNum,
                                              uint32_t queryMoveOffset,
                                              uint32_t queryMoveNum,
                                              LocalTensor<half> &dist)
...
__aicore__ inline void DistanceFlatIP::CubeComputeLoop(uint32_t codeMoveOffset,
                                                       uint32_t codeMoveNum,
                                                       uint32_t queryMoveOffset,
                                                       uint32_t queryMoveNum,
                                                       bool isTail)
...
extern "C" __global__ __aicore__ void distance_flat_ip(GM_ADDR query, GM_ADDR mask, GM_ADDR shaped, GM_ADDR actualSize,
                                                       GM_ADDR dist, GM_ADDR maxDist, GM_ADDR flag,
                                                       GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    IndexOps::DistanceFlatIP op(tilingData);
    if ASCEND_IS_AIV {
