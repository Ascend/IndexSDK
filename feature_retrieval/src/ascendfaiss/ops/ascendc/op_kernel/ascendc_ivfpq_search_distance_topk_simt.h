...
__aicore__ inline void AscendcIvfpqSearchDistanceTopKSimt::DistCompute(
    __ubuf__ float *queryPQUb, __gm__ uint8_t *codeBase, __gm__ int64_t *codeSize, __gm__ int64_t *codeOffset,
    __ubuf__ float *distResultUbPtr, int innerBlockindex, int blockIndex)
{
    if (this->subSpaceNum == 2)
    {
        Simt::VF_CALL<SimtSearchComputeSimtV1<2>>(Simt::Dim3{IVFPQ_THREAD_NUM, 1, 1}, queryPQUb, codeBase,
                                                  distResultUbPtr, codeSize, codeOffset, this->ksub, this->codeBlockNum,
