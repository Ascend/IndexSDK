...
__aicore__ inline uint32_t Ceiling(uint32_t a, uint32_t b) { return (a + b - 1) / b; }
...
class MatmulKernel
{
   public:
    ...
    __aicore__ inline void Init(GM_ADDR a, GM_ADDR b, GM_ADDR c, GM_ADDR workspace, uint64_t memSize,
 ...
 * @retval None
 */
extern "C" __global__ __aicore__ void matmul_at_fp32(GM_ADDR a, GM_ADDR b, GM_ADDR c, GM_ADDR workspace, GM_ADDR tiling)
{
