...
if (ASCEND_SEARCH)
    set(ASCEND_COMPUTE_UNIT ascend310p ascend910b ascend910_93 ascend910_95)
else()
    set(ASCEND_COMPUTE_UNIT ascend910b ascend910_93 ascend910_95)
endif()
set(ASCEND_TENSOR_COMPILER_PATH ${ASCEND_TOOLKIT_PATH}/compiler)
