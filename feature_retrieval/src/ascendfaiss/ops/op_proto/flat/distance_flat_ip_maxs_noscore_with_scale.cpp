...
#include "./distance_flat_ip_maxs_noscore_with_scale.h"
#include <string>
#include <vector>

namespace ge {
IMPLEMT_VERIFIER(DistanceFlatIPMaxsNoScoreWithScale, Verify)
{
...
COMMON_INFER_FUNC_REG(DistanceFlatIPMaxsNoScoreWithScale, InferShape);

// Registered verify function
VERIFY_FUNC_REG(DistanceFlatIPMaxsNoScoreWithScale, Verify);
}