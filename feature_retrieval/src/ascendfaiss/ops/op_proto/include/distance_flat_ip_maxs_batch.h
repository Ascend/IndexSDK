...
#ifndef GE_OP_DISTANCECOMPUTE_FLAT_IP_MAXS_BATCH_H
#define GE_OP_DISTANCECOMPUTE_FLAT_IP_MAXS_BATCH_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceFlatIPMaxsBatch)
    ...
    .OP_END_FACTORY_REG(DistanceFlatIPMaxsBatch)
} // namespace ge

#endif // GE_OP_DISTANCECOMPUTE_FLAT_IP_MAXS_BATCH_H
