...
#ifndef GE_OP_DISTANCE_MASKED_SQ8_IP_MAXS_H
#define GE_OP_DISTANCE_MASKED_SQ8_IP_MAXS_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceMaskedSQ8IPMaxs)
        ...
        .OP_END_FACTORY_REG(DistanceMaskedSQ8IPMaxs)
} // namespace ge
