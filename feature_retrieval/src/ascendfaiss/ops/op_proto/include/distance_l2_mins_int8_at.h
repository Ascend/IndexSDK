...
#ifndef GE_OP_DISTANCE_L2_MINS_INT8_AT_H
#define GE_OP_DISTANCE_L2_MINS_INT8_AT_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceL2MinsInt8At)
    ...
    .INPUT(x3, TensorType({ DT_INT32 }))          /* "Third operand." */
    ...
    .OP_END_FACTORY_REG(DistanceL2MinsInt8At)
} // namespace ge

#endif // GE_OP_DISTANCE_L2_MINS_INT8_AT_H