...
#ifndef GE_OP_DISTANCE_MASKED_SQ8_IP_MAXS_DIM64_H
#define GE_OP_DISTANCE_MASKED_SQ8_IP_MAXS_DIM64_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceMaskedSQ8IPMaxsDim64)
        ...
        .OP_END_FACTORY_REG(DistanceMaskedSQ8IPMaxsDim64)
} // namespace ge
#endif // GE_OP_DISTANCE_MASKED_SQ8_IP_MAXS_DIM64_H