...
#ifndef GE_OP_DISTANCE_INT8_COS_MAXS_WITH_MASK_EXTRA_SCORE_H
#define GE_OP_DISTANCE_INT8_COS_MAXS_WITH_MASK_EXTRA_SCORE_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceInt8CosMaxsWithMaskExtraScore)
        ...
        .INPUT(x6, TensorType({ DT_FLOAT16 }))
        .OUTPUT(y0, TensorType({ DT_FLOAT16 }))
        .OUTPUT(y1, TensorType({ DT_FLOAT16 }))
        .OUTPUT(y2, TensorType({ DT_UINT16 }))
        .OP_END_FACTORY_REG(DistanceInt8CosMaxsWithMaskExtraScore)
} // namespace ge
#endif // GE_OP_DISTANCE_INT8_COS_MAXS_WITH_MASK_EXTRA_SCORE_H