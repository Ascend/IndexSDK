...
#ifndef GE_OP_DISTANCE_INT8_L2_FULL_MINS_WITH_MASK_H
#define GE_OP_DISTANCE_INT8_L2_FULL_MINS_WITH_MASK_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceInt8L2FullMinsWithMask)
    ...
    .OP_END_FACTORY_REG(DistanceInt8L2FullMinsWithMask)
} // namespace ge

#endif // GE_OP_DISTANCE_INT8_L2_FULL_MINS_WITH_MASK_H