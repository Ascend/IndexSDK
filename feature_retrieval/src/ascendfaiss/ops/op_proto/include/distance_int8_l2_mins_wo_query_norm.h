...
#ifndef GE_OP_DISTANCE_INT8_L2_MINS_WO_QUERY_NORM_H
#define GE_OP_DISTANCE_INT8_L2_MINS_WO_QUERY_NORM_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceInt8L2MinsWoQueryNorm)
    ...
    .OP_END_FACTORY_REG(DistanceInt8L2MinsWoQueryNorm)
} // namespace ge

#endif // GE_OP_DISTANCE_INT8_L2_MINS_WO_QUERY_NORM_H