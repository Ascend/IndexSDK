...
#ifndef GE_OP_DISTANCECOMPUTE_BINARY_FLOAT_H
#define GE_OP_DISTANCECOMPUTE_BINARY_FLOAT_H
 
#include "graph/operator_reg.h"
 
namespace ge {
REG_OP(DistanceBinaryFloat)
    ...
    .OP_END_FACTORY_REG(DistanceBinaryFloat)
} // namespace ge
 
#endif // GE_OP_DISTANCECOMPUTE_BINARY_FLOAT_H