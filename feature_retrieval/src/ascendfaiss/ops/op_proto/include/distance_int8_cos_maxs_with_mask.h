...
#ifndef GE_OP_DISTANCE_INT8_COS_MAXS_WITH_MASK_H
#define GE_OP_DISTANCE_INT8_COS_MAXS_WITH_MASK_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceInt8CosMaxsWithMask)
        ...
        .OP_END_FACTORY_REG(DistanceInt8CosMaxsWithMask)
} // namespace ge
#endif // GE_OP_DISTANCE_INT8_COS_MAXS_WITH_MASK_H