...
#ifndef GE_OP_DISTANCE_FLAT_L2_MINS_AT_H
#define GE_OP_DISTANCE_FLAT_L2_MINS_AT_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceFlatL2MinsAt)
    ...
    .OP_END_FACTORY_REG(DistanceFlatL2MinsAt)
} // namespace ge

#endif // GE_OP_DISTANCE_FLAT_L2_MINS_AT_H