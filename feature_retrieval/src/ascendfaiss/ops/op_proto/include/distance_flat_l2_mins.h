...
#ifndef GE_OP_DISTANCE_FLAT_L2_MINS_H
#define GE_OP_DISTANCE_FLAT_L2_MINS_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceFlatL2Mins)
    ...
    .OP_END_FACTORY_REG(DistanceFlatL2Mins)
} // namespace ge

#endif // GE_OP_DISTANCE_FLAT_L2_MINS_H