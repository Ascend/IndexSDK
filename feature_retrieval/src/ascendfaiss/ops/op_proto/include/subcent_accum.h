...
#ifndef GE_OP_SUBCENT_ACCUM_H
#define GE_OP_SUBCENT_ACCUM_H
...
namespace ge {
    REG_OP(SubcentAccum)
        ...
        .INPUT(x1, TensorType({ DT_INT16 }))              /* "Second operand." */
        .INPUT(x2, TensorType({ DT_UINT16 }))               /* "Third operand." */
        ...
        .OP_END_FACTORY_REG(SubcentAccum)
} // namespace ge
