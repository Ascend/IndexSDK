...
#ifndef GE_OP_DISTANCE_IVF_SQ8_IP8_H
#define GE_OP_DISTANCE_IVF_SQ8_IP8_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceIVFSQ8IP8)
        ...
        .INPUT(x4, TensorType({ DT_UINT32 }))                    /* "Fourth operand." */
        ...
        .OP_END_FACTORY_REG(DistanceIVFSQ8IP8)
} // namespace ge
#endif // GE_OP_DISTANCE_IVF_SQ8_IP8_H