...
#ifndef GE_OP_DISTANCE_FLAT_SUBCENTERS_H
#define GE_OP_DISTANCE_FLAT_SUBCENTERS_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceFlatSubcenters)
    ...
    .INPUT(x3, TensorType({ DT_UINT16 })) /* "Fourth operand." */
    /* "Result, has same element type as three inputs" */
    .OUTPUT(y0, TensorType({ DT_FLOAT16 }))
    .OUTPUT(y1, TensorType({ DT_UINT16 }))
    .OP_END_FACTORY_REG(DistanceFlatSubcenters)
} // namespace ge

#endif // GE_OP_DISTANCE_FLAT_SUBCENTERS_H
