...
namespace ge {
    IMPLEMT_VERIFIER(L2NormTypingInt8, L2NormTypingInt8Verify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(L2NormTypingInt8InferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(L2NormTypingInt8, L2NormTypingInt8InferShape);

    // Registered verify function
    VERIFY_FUNC_REG(L2NormTypingInt8, L2NormTypingInt8Verify);
} // namespace ge