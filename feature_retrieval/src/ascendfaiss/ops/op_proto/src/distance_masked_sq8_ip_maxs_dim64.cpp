...
#include "distance_masked_sq8_ip_maxs_dim64.h"
...
namespace ge {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceMaskedSQ8IPMaxsDim64InferShape)
    {
        ...
        dim_max_y.push_back((dims_x2[0] * 16 + 63) / 64 * 2);
    ...
    COMMON_INFER_FUNC_REG(DistanceMaskedSQ8IPMaxsDim64, DistanceMaskedSQ8IPMaxsDim64InferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceMaskedSQ8IPMaxsDim64, DistanceMaskedSQ8IPMaxsDim64Verify);
} // namespace ge