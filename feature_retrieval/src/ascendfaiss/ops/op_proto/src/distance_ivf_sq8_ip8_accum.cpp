...
#include "distance_ivf_sq8_ip8_accum.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceIVFSQ8IP8Accum, DistanceIVFSQ8IP8AccumVerify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceIVFSQ8IP8AccumInferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceIVFSQ8IP8Accum, DistanceIVFSQ8IP8AccumInferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceIVFSQ8IP8Accum, DistanceIVFSQ8IP8AccumVerify);
} // namespace ge