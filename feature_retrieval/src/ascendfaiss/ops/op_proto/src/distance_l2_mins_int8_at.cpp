...
#include "distance_l2_mins_int8_at.h"
...
namespace ge {
IMPLEMT_VERIFIER(DistanceL2MinsInt8At, DistanceL2MinsInt8AtVerify)
{
...
IMPLEMT_COMMON_INFERFUNC(DistanceL2MinsInt8AtInferShape)
{
...
COMMON_INFER_FUNC_REG(DistanceL2MinsInt8At, DistanceL2MinsInt8AtInferShape);

// Registered verify function
VERIFY_FUNC_REG(DistanceL2MinsInt8At, DistanceL2MinsInt8AtVerify);
} // namespace ge
