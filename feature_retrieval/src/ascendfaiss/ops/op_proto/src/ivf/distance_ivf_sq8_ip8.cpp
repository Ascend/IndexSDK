...
#include "distance_ivf_sq8_ip8.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceIVFSQ8IP8, DistanceIVFSQ8IP8Verify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceIVFSQ8IP8InferShape)
    {
        ...
        dim_y0.push_back(8);
        dim_y0.push_back(dims_x1[0] / dims_x0[1]);
        ...
        int burst = (dims_x0[1] > 256) ? 16 : 32; // Choose 16 or 32 according to whether dim is greater than 256
        dim_max_y.push_back(8);
        dim_max_y.push_back(dim_y0[1] / burst * 2);
        ...
        std::vector<int64_t> dimVec2 { 8, 32 };
    ...
    COMMON_INFER_FUNC_REG(DistanceIVFSQ8IP8, DistanceIVFSQ8IP8InferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceIVFSQ8IP8, DistanceIVFSQ8IP8Verify);
} // namespace ge