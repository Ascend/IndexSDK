...
#include "distance_masked_sq8_ip_maxs.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceMaskedSQ8IPMaxs, DistanceMaskedSQ8IPMaxsVerify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceMaskedSQ8IPMaxsInferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceMaskedSQ8IPMaxs, DistanceMaskedSQ8IPMaxsInferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceMaskedSQ8IPMaxs, DistanceMaskedSQ8IPMaxsVerify);
} // namespace ge