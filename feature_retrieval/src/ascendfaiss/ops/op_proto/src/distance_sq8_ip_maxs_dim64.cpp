...
#include "distance_sq8_ip_maxs_dim64.h"
...
namespace ge {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceSQ8IPMaxsDim64InferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceSQ8IPMaxsDim64, DistanceSQ8IPMaxsDim64InferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceSQ8IPMaxsDim64, DistanceSQ8IPMaxsDim64Verify);
} // namespace ge