...
#include "distance_int8_cos_maxs_filter.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceInt8CosMaxsFilter, DistanceInt8CosMaxsFilterVerify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceInt8CosMaxsFilterInferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceInt8CosMaxsFilter, DistanceInt8CosMaxsFilterInferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceInt8CosMaxsFilter, DistanceInt8CosMaxsFilterVerify);
} // namespace ge