...
#include "distance_int8_cos_maxs_with_mask.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceInt8CosMaxsWithMask, DistanceInt8CosMaxsWithMaskVerify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceInt8CosMaxsWithMaskInferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceInt8CosMaxsWithMask, DistanceInt8CosMaxsWithMaskInferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceInt8CosMaxsWithMask, DistanceInt8CosMaxsWithMaskVerify);
} // namespace ge