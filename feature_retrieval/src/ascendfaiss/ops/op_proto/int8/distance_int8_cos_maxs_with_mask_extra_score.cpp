...
#include "distance_int8_cos_maxs_with_mask_extra_score.h"
...
namespace ge {
    IMPLEMT_VERIFIER(DistanceInt8CosMaxsWithMaskExtraScore, DistanceInt8CosMaxsWithMaskExtraScoreVerify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceInt8CosMaxsWithMaskExtraScoreInferShape)
    {
        DataType x3_dtype = op.GetInputDescByName("x3").GetDataType();
        Format x3_format = op.GetInputDescByName("x3").GetFormat();

        Shape x0_shape = op.GetInputDescByName("x0").GetShape();
        Shape x4_shape = op.GetInputDescByName("x4").GetShape();
    ...
    COMMON_INFER_FUNC_REG(DistanceInt8CosMaxsWithMaskExtraScore, DistanceInt8CosMaxsWithMaskExtraScoreInferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceInt8CosMaxsWithMaskExtraScore, DistanceInt8CosMaxsWithMaskExtraScoreVerify);
} // namespace ge