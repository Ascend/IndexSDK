...
#include "distance_int8_l2_full_mins.h"
...
namespace ge {
IMPLEMT_VERIFIER(DistanceInt8L2FullMins, DistanceInt8L2FullMinsVerify)
{
...
IMPLEMT_COMMON_INFERFUNC(DistanceInt8L2FullMinsInferShape)
{
...
COMMON_INFER_FUNC_REG(DistanceInt8L2FullMins, DistanceInt8L2FullMinsInferShape);

// Registered verify function
VERIFY_FUNC_REG(DistanceInt8L2FullMins, DistanceInt8L2FullMinsVerify);
} // namespace ge