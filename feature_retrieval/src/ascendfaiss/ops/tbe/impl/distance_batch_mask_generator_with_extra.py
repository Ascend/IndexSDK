...
def distance_batch_mask_generator_with_extra(input_x0, input_x1, input_x2, input_x3, input_x4, input_x5, input_x6,
                                       output_y0,
                                       kernel_name="distance_batch_mask_generator_with_extra"):
    """
    距离结果掩码生成算子
    Args:
