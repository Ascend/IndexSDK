...
class DistanceInt8L2MinsWithMask:
...
def distance_int8_l2_mins_with_mask(input_queries, input_mask, input_centroids,
                                    input_precomputed, input_actual_num,
                                    output_dist, output_min_dist, output_flag,
                                    kernel_name="distance_int8_l2_mins_with_mask"):
    obj = DistanceInt8L2MinsWithMask(input_queries, input_mask,
                                     input_centroids, input_precomputed,
                                     input_actual_num, output_dist,
                                     output_min_dist, output_flag,
                                     False, kernel_name)
