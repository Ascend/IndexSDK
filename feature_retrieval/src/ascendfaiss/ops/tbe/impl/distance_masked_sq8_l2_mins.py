...
class DistanceSQ8L2Mins:
    def __init__(self,
                 ...
                 output_mins,
                 output_flag,
                 kernel_name="distance_masked_sq8_l2_mins"):
    ...
    def cal_num_each_core(self):
        ...
        self.use_mask = self.tik_instance.Scalar(dtype="uint32",
                                                 name="use_mask",
                                                 init_value=0)
        self.use_mask.set_as(actual_code_num_ub[3])
        ...
        if flag == 0:
            with self.tik_instance.for_range(0, 2, thread_num=1) as i:
                ...
                with self.tik_instance.if_scope(self.use_mask > 0):
                    ...
                    with self.tik_instance.for_range(0, queries_move_num, dtype="int64") as j:
    ...
    def get_tik_instance(self):
        ...
        self.tik_instance.BuildCCE(
            ...
            inputs=[
                self.input_queries_gm, self.input_mask_gm, self.input_code_gm,
...
def distance_masked_sq8_l2_mins(input_queries,
                                input_mask,
                                input_code,
                                input_precomputed,
                                input_diff,
    ...
    kernel_name : str
        kernel name, default value is "distance_masked_sq8_l2_mins"

    Returns
    -------
    None
    """
    distance_sq8 = DistanceSQ8L2Mins(input_queries, input_mask, input_code,
