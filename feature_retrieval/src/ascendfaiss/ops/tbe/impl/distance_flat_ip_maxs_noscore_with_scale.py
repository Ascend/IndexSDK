...
def distance_flat_ip_maxs_noscore_with_scale(input_queries,
                                             input_code,
                                             input_actual_num,
                                             input_mask,
                                             input_scale,
                                             ...
                                             output_maxs,
                                             output_flag,
                                             kernel_name="distance_flat_ip_maxs_noscore_with_scale"):
    """
    算子接口函数
    Args:
        ...
        input_scale：底库向量化，一维Tensor，shape(dim,)，dtype=float16。
