...
def distance_flat_ip_maxs_with_extra_score(input_queries,
                                           input_code,
                                           input_actual_num,
                                           input_mask,
                                           input_extra_score,
                                           ...
                                           output_maxs,
                                           output_flag,
                                           kernel_name="distance_flat_ip_maxs_with_extra_score"):
    """
    算子接口函数
    Args:
        ...
        output_flag: 算子执行完成标志，算子调用者可以轮巡该标志位，为了兼容已有代码，定义为uin16类型，一维Tensor，shape=(16,)。 
    约束：
