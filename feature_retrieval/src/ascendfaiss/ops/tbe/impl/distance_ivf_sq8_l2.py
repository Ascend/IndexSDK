...
class DistanceIVFSQ8L2:
    ...
    def cal_num_each_core(self):
        ...
        if self.aicore_use == 2:
            ...
            self.code_num_each_core = actual_num // self.aicore_use // self.code_each_loop * self.code_each_loop
    ...
    def distance_compute(self):
        ...
        with self.tik_instance.for_range(0, self.aicore_use, block_num=self.aicore_use) as block_index:
            ...
            self.tik_instance.data_move(self.output_flag_gm[block_index, 0], flag_ub,
                                        0, 1, 1, 0, 0)
