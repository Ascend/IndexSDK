...
class DistanceSQ8IPMaxs:
    ...
    def set_src_dst_tensor(self):
        ...
        # creat input tensor: input_queries_gm, input_mask_gm, input_code_gm,
...
def distance_masked_sq8_ip_maxs(input_queries,
                                input_mask,
                                input_code,
                                input_diff,
                                input_min,
                                ...
                                output_maxs,
                                output_flag,
                                kernel_name="distance_masked_sq8_ip_maxs"):
    """
    ...
    kernel_name : str
        kernel name, default value is "distance_masked_sq8_ip_maxs"

    Returns
    -------
    None
    """
    distance_sq8 = DistanceSQ8IPMaxs(input_queries, input_mask, input_code, input_diff,
