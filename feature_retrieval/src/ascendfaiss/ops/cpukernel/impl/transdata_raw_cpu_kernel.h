...
#ifndef AICPU_TRANSDATA_RAW_CPU_KERNEL_H
#define AICPU_TRANSDATA_RAW_CPU_KERNEL_H
...
namespace aicpu {
class TransdataRawCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    TransdataRawCpuKernel() = default;

    ~TransdataRawCpuKernel() override = default;
