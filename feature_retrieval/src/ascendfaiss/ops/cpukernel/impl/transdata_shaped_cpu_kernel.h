...
#ifndef AICPU_TRANSDATA_SHAPED_CPU_KERNEL_H
#define AICPU_TRANSDATA_SHAPED_CPU_KERNEL_H
...
namespace aicpu {
class TransdataShapedCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    TransdataShapedCpuKernel() = default;

    ~TransdataShapedCpuKernel() override = default;
