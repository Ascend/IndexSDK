...
#ifndef AICPU_TRANSDATA_DIST_CPU_KERNEL_H
#define AICPU_TRANSDATA_DIST_CPU_KERNEL_H
...
namespace aicpu {
class TransdataDistCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    TransdataDistCpuKernel() = default;

    ~TransdataDistCpuKernel() override = default;
