...
#ifndef AICPU_REMOVEDATA_ATTR_CPU_KERNEL_H
#define AICPU_REMOVEDATA_ATTR_CPU_KERNEL_H
...
namespace aicpu {
class RemovedataAttrCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    RemovedataAttrCpuKernel() = default;
    ~RemovedataAttrCpuKernel() override = default;
