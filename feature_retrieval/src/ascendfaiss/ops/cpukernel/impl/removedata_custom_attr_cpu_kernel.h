...
#ifndef AICPU_REMOVEDATA_CUSTOM_ATTR_CPU_KERNEL_H
#define AICPU_REMOVEDATA_CUSTOM_ATTR_CPU_KERNEL_H
...
namespace aicpu {
class RemovedataCustomAttrCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    RemovedataCustomAttrCpuKernel() = default;
    ~RemovedataCustomAttrCpuKernel() override = default;
