...
#ifndef AICPU_TOPK_FLAT_CPU_KERNEL_H
#define AICPU_TOPK_FLAT_CPU_KERNEL_H
...
namespace aicpu {
class TopkFlatCpuKernel : public CpuKernel {
struct Inputs {
...
public:
    TopkFlatCpuKernel() = default;

    ~TopkFlatCpuKernel() override = default;
...
private:
    ...
    template <typename T, typename C>
    void ReorderLastBlock(float16_t *outdists, T *outlabel, C &&cmp);
