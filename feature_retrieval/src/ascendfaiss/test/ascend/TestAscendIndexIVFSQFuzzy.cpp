...
TEST(TestAscendIndexIVFSQFuzzy, All)
{
    int dim = 64;
    int ntotal = 125000;
    int ncentroids = 8192;
    ...
    faiss::ascend::AscendIndexIVFSQFuzzyConfig conf({1 });
    conf.cp.niter = 16;
    faiss::ascend::AscendIndexIVFSQFuzzy index(dim, ncentroids, faiss::ScalarQuantizer::QuantizerType::QT_8bit,
    ...
    int realTotal = index.ntotal;
    {
        ...
        ASSERT_EQ(tmpTotal, realTotal * 2);
    }
...
TEST(TestAscendIndexIVFSQFuzzy, CloneAscend2CPU)
{
    int dim = 64;
    int ntotal = 125000;
    int ncentroids = 8192;
    ...
    const char *outfilename = "./ivfsqfuzzytest.faiss";
...
TEST(TestAscendIndexIVFSQFuzzy, CloneCPU2Ascend)
{
    int dim = 64;
    int ntotal = 125000;
    int ncentroids = 8192;
    ...
    const char *indexfilename = "./ivfsqfuzzytest.faiss";
