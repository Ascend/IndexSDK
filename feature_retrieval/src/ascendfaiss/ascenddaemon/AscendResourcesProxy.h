...
public:
    ...
    [[nodiscard]] inline std::shared_ptr<AscendStreamIntf> getDefaultStream() const
    {
        return resources->getDefaultStream();
    }

    [[nodiscard]] inline std::vector<std::shared_ptr<AscendStreamIntf>> getAlternateStreams() const
    {
    ...
    inline bool getUseOnlineOp()
    {
        return resources->useOnlineOp;
    }

    AscendResourcesProxy(const AscendResourcesProxy&) = delete;
    AscendResourcesProxy& operator=(const AscendResourcesProxy&) = delete;
