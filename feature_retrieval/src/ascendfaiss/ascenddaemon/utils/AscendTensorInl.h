    ...
    : AscendTensor(nullptr, sizes)
{
    ...
    auto memory = m.getMemory(stream, sizeof(T) * this->numElements());
                                                           ...
                                                           aclrtMemcpyKind kind)
{
    ...
    if (t.numElements() > 0)
    {
        ...
        auto ret =
            aclrtMemcpy((void *)this->data(), this->getSizeInBytes(), (void *)t.data(), t.getSizeInBytes(), kind);
                                                         ...
                                                         aclrtMemcpyKind kind)
{
    ...
    if (this->numElements() > 0)
    {
        ...
        auto ret =
            aclrtMemcpy((void *)t.data(), t.getSizeInBytes(), (void *)this->data(), this->getSizeInBytes(), kind);
        ASCEND_THROW_IF_NOT_FMT(ret == ACL_SUCCESS, "Mem operator error %d", (int)ret);
    }
}
